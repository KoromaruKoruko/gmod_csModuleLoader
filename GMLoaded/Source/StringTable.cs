...
namespace GMLoaded.Source
{
    ...
    // TODO: Self Assert SERVER or CLIENT
    ...
    public class StringTable
    {
        ...
        static StringTable() =>
#if CLIENT
            container = NativeInterface.Load<INetworkStringTableContainer>("engine", "VEngineClientStringTable001");
#elif SERVER
            container = NativeInterface.Load<INetworkStringTableContainer>("engine", "VEngineServerStringTable001");
#else
