...
namespace GMLoaded.Native
{
    ...
    {
        public static IntPtr AllocMem(IntPtr BaseAddr, Int32 Size) => Natives.Kernel32.VirtualAlloc(BaseAddr, (IntPtr)Size, Natives.Kernel32.AllocationType.COMMIT, Natives.Kernel32.MemoryProtection.EXECUTE_READWRITE);

        public static void Link(IntPtr Addr, Delegate Func)
        {
            // TODO: Make this work Nativly with linux
