...
namespace Libraria.Native
{
    public static class JIT
    {
        ...
        {
            Type WrapperType = CreateWrapper<T>(Instance, out NativeClassInfo NativeInfo);
...
#pragma warning disable IDE0060 // Remove unused parameter, public domain, Ignoring!
        ...
        public static ICustomMarshaler GetInstance(String Cookie) => new NativeClassMarshal<T>();
